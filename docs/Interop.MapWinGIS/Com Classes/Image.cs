...
namespace MapWinGIS
{
    ...
    #endif
    {
        ...
        /// <param name="Row">The row.</param>
        /// \new48 Added in version 4.8
        public void ProjectionToImage(double ProjX, double ProjY, out int Column, out int Row)
        {
            throw new NotImplementedException();
        }
        ...
        public void set_Value(int Row, int Column, int pVal)
        {
            throw new NotImplementedException();
        }
        ...
        /// @{
            ...
            /// \new494 Added in version 4.9.4
            public uint get_ValueWithAlpha(int Row, int Column)
            {
                return 1;
            }
            ...
            /// \new494 Added in version 4.9.4
            public void set_ValueWithAlpha(int Row, int Column, uint pVal)
            {
                throw new NotImplementedException();
            }
