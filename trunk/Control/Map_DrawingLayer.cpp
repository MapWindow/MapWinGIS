...
//		Draw the DrawLayers
// ******************************************************************
void CMapView::DrawLists(const CRect & rcBounds, CDC * dc,tkDrawReferenceList listType)
{
	...
	CLabelDrawer lblDrawer(dc, &extents, m_pixelPerProjectionX, m_pixelPerProjectionY, this->GetCurrentScale(), &collisionList, m_RotateAngle );
	
	// label drawer for screen referenced list
	Extent ext(rcBounds.left, rcBounds.right, rcBounds.top, rcBounds.bottom);
	CLabelDrawer lblDrawerScreen(dc, &ext, &collisionList, m_RotateAngle );
...
//		DrawDrawing()
// *****************************************************************
void CMapView::DrawDrawing(CDC * dc, DrawList * dlist)//, CLabelDrawer* lblDrawer)
{
