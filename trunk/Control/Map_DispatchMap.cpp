...
BEGIN_DISPATCH_MAP(CMapView, COleControl)
	...
	DISP_PROPERTY_EX_ID(CMapView, "AnimationOnZooming", dispidAnimationOnZooming, GetAnimationOnZooming, SetAnimationOnZooming, VT_BOOL)
	DISP_PROPERTY_EX_ID(CMapView, "InertiaOnPanning", dispidInertiaOnPanning, GetInertiaOnPanning, SetInertiaOnPanning, VT_BOOL)
