...
BEGIN_DISPATCH_MAP(CMapView, COleControl)
	...
	DISP_PROPERTY_EX_ID(CMapView, "EditShape", dispidEditShape, GetEditShape, SetNotSupported, VT_DISPATCH)
...
BEGIN_EVENT_MAP(CMapView, COleControl)
	...
	EVENT_CUSTOM_ID("ShapeEditing", eventidShapeEditing, FireShapeEditing, VTS_DISPATCH VTS_I4 VTS_PI4)
	EVENT_CUSTOM_ID("SelectShape", eventidSelectShape, FireSelectShape, VTS_R8 VTS_R8 VTS_PI4 VTS_PI4 VTS_PI4)
