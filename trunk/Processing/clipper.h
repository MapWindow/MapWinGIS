...
* http://www.me.berkeley.edu/~mcmains/pubs/DAC05OffseClipperLib::Polygon.pdf              *
*                                                                              *
*******************************************************************************/
...
public:
  ...
  // by lsu
  TEdge * PreparePolygon(const Polygon &pg, PolyType polyType);
  bool PreparePolygons(const Polygons &ppg, PolyType polyType, std::vector<TEdge*>& resultEdges);
  bool AddPreparedPolygon( TEdge *edges );
  bool AddPreparedPolygons( std::vector<TEdge*>& edges );
