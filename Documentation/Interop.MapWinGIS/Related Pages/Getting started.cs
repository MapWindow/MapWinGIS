...
/// AxMap.TileProvider = tkTileProvider.BingHybrid;
...
///
/// To change the area of map being displayed the following properties can be used: AxMap.Latitude, AxMap.Longitude, AxMap.CurrentZoom. 
...
/// </div>
///
/// Additional information displayed on the map can be configured using:
...
///
/// Let's add a button, double-click on it and start typing some code. We shall see VS Intellisense autocomplete menu, however there won't be any description of members.
/// <div class="left">
/// \image html intellisense.jpg
/// </div>
/// To fix this use the following steps:\n\n
/// 1. Download documentation files for Interop assemblies from <a href="MapWinGIS_Intellisense.rar" class="bold">here</a> \n
/// There are 2 files: Interop.MapWinGIS.XML and AxInterop.MapWinGIS.XML with the latest documentation.\n\n
/// 2. Open obj\\Debug folder in your project and copy XML documentation files there. The names of Interop assemblies which should be already 
/// there must match the names of files without extension: Interop.MapWinGIS.dll and AxInterop.MapWinGIS.dll.\n\n
/// 3. Reload your WinForms project to make sure the new files are found.\n\n
