...
namespace MWLite.Symbology.Forms.Categories
{
    public partial class CategoriesForm : Form
    {
        ...
        /// </summary>
        public CategoriesForm(LegendControl.Legend legend, MapWinGIS.Shapefile sf, int layerHandle)
        {
            Init(legend, sf, layerHandle);
        }

        public CategoriesForm(LegendControl.Legend legend, int layerHandle)
        {
        ...
        private void Init(LegendControl.Legend legend, MapWinGIS.Shapefile sf, int layerHandle)
        {
            InitializeComponent();
            m_shapefile = sf;
            m_legend = legend;
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Do you want to copy categories definitions from labels?", LegendControl.Legend.AppName,
        ...
        private void btnLabelsCopy_Click(object sender, EventArgs e)
        {
            ...
            if (dgvLabels.Rows.Count > 0)
            {
                if (MessageBox.Show("Do you want to copy categories definitions from shapefile?", LegendControl.Legend.AppName,
                                MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
                    return;
                }
