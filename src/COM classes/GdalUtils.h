...
public:
	...
	STDMETHOD(GdalVectorReproject)(/*[in]*/ BSTR sourceFilename, /*[in]*/ BSTR destinationFilename, /*[in]*/ int sourceEpsgCode, /*[in]*/ int destinationEpsgCode, /*[in, optional, defaultvalue(FALSE)]*/ VARIANT_BOOL useSharedConnection, /*[out, retval]*/ VARIANT_BOOL* retVal);
