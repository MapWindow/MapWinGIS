...
public:
	...
	static bool CloneNoFields2(IShapefile* sfSource, IShapefile** retVal, ShpfileType shpType, bool addShapeId = false);
	static bool CloneNoFields2(IShapefile* sf, IShapefile** retVal, bool addShapeId = false);
