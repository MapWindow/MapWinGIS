...
public:
	...
	virtual bool IsSphericalMercator() noexcept { return false; }
	bool IsWorldWide() noexcept { return _worldWide; }
	double get_MinLat() noexcept { return _minLat; }
	double get_MaxLat() noexcept { return _maxLat; }
	double get_MinLong() noexcept { return _minLng; }
	double get_MaxLong() noexcept { return _maxLng; }
	bool get_ClipBoundsChanged() noexcept { return _clipBoundsChanged; }
	Extent get_MapBounds() noexcept { return _mapBounds; }
	int get_MapProjectionCount() noexcept { return _mapProjectionCount; }
	...
	static double Clip(const double n, const double minValue, const double maxValue) noexcept { return MIN(MAX(n, minValue), maxValue); }
};