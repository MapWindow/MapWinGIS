...
namespace MWLite.Symbology.Forms.Labels
{
    ...
    public partial class LabelStyleForm : Form
    {
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            ...
            {
                string expr = MWLite.Symbology.Classes.LabelUtilities.FixExpression(richTextBox1.Text);
        ...
        private void richTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (!m_NoEvents)
            {
                MWLite.Symbology.Classes.LabelUtilities.DrawPreview(m_category, m_shapefile, pctPreview, richTextBox1.Text, true);
                RefreshControls();
            }
