...
namespace MapWindow.Legend.Forms.Symbology
{
    public partial class LinesForm : Form
    {
        ...
        internal Controls.Legend.Legend m_legend = null;
        ...
        /// </summary>
        public LinesForm(Controls.Legend.Legend legend, Layer layer, ShapeDrawingOptions options, bool applyDisabled)
        {
            InitializeComponent();
