...
namespace MapWindow.Legend.Forms.Utilities
{
    public partial class frmOptionsManager : Form
    {
        ...
        /// </summary>
        public frmOptionsManager(Controls.Legend.Legend legend, int handle)
        {
            InitializeComponent();
            ...
            if (form.ShowDialog(this) == DialogResult.OK)
            {
                ...
                if (System.IO.File.Exists(name))
                {
                    if (MessageBox.Show("Set of options with such name already exists." + Environment.NewLine +
                                    "Do you want to rewrite it?", Legend.Controls.Legend.Legend.AppName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes) return;
                }
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            if (map != null)
            {
                if (MessageBox.Show("Do you want to remove all option sets for the layer?", Legend.Controls.Legend.Legend.AppName,
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Do you want to remove the following set of options: " + name + "?", Legend.Controls.Legend.Legend.AppName,
                            MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (map != null)
                {
                    ...
                    {
                        Globals.MessageBoxError("Failed to remove options." + Environment.NewLine +
