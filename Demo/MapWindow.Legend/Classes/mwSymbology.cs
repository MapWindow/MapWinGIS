...
namespace MapWindow.Legend.Classes
{
    ...
    //    public MapWindow.Legend.Forms.SymbologyMainForm m_mainForm = null;
    ...
    //            if (sf != null)
    //            {
    //                MapWindow.Legend.Layer layer = m_legend.Layers.ItemByHandle(handle);
    ...
    //                if (fieldIndex == -1)
    //                {
    //                    Forms.ChartStyleForm form = new MapWindow.Legend.Forms.ChartStyleForm(this, sf, true, handle);
    ...
    //                        dialog.Color = Colors.UintToColor(field.Color);
    ...
    //    //            else
    //    //            {
    //    //                Globals.MessageBoxInformation("Active layer should be a shapefile");
    //    //            }
    //    //            break;
    ...
    //    public void LayersAdded(MapWindow.Legend.Layer[] Layers)
    //    {
    //        foreach (MapWindow.Legend.Layer layer in Layers)
    //        {
    ...
    //        MapWindow.Legend.Layer layer = Legend.GetLayer(layerHandle);
    //        if (layer != null)
    //        {
